...
public class ServerManager : MonoBehaviour
{
	...
	{
        if (GameManager.instance.mostrarDebug) Debug.Log("SM: llamando a las unidades");
        ...
        //{
        if (GameManager.instance.mostrarDebug) Debug.Log("SM Error: " + request.error);
            //peticionUnidades();
            try
            {
                if (GameManager.instance.mostrarDebug) Debug.Log("SM:(Server no disponible) FALSEANDO unidades... " + request.downloadHandler.text);
                ...
                if (GameManager.instance.mostrarDebug) Debug.Log("SM Unidades FALSEADAS: " + JsonHelper.ToJson(GameManager.instance.BDlocal.TiposUnidad.ToArray()));
            }
            catch (System.Exception e)
            {
                if (GameManager.instance.mostrarDebug) Debug.Log("SM: ERROR FALSEADAS unidades -> " + e);
            }
   //     }
   //     else
   //     {
   ...
   //     }
    ...
    {
        if (GameManager.instance.mostrarDebug) Debug.Log("SM: llamando a las habilidades");
        ...
        //{
            ...
            string jsonColeccion = "[{\"id\":\"1\",\"nombre\":\"habTest1\",\"poder\":null,\"tipo\":\"FISICO\",\"esfuerzo\":\"1\",\"tipoRango\":\"2\",\"rango\":\"1\",\"potencia\":\"1\"},{\"id\":\"2\",\"nombre\":\"habTest2\",\"poder\":null,\"tipo\":\"FISICO\",\"esfuerzo\":\"2\",\"tipoRango\":\"2\",\"rango\":\"1\",\"potencia\":\"2\"},{\"id\":\"3\",\"nombre\":\"habEsp1\",\"poder\":null,\"tipo\":\"ESPECIAL\",\"esfuerzo\":\"3\",\"tipoRango\":\"3\",\"rango\":\"2\",\"potencia\":\"10\"},{\"id\":\"4\",\"nombre\":\"habEsp2\",\"poder\":null,\"tipo\":\"ESPECIAL\",\"esfuerzo\":\"4\",\"tipoRango\":\"1\",\"rango\":\"1\",\"potencia\":\"20\"}]";
            try
            {
                if (GameManager.instance.mostrarDebug) Debug.Log("SM:(Server no disponible) FALSEANDO habilidades: " + jsonColeccion);
                ...
                if (GameManager.instance.mostrarDebug) Debug.Log("SM: Habilidades FALSEADAS: " + JsonHelper.ToJson(GameManager.instance.BDlocal.Habilidades.ToArray()));

            }
            catch (System.Exception e)
            {
                if (GameManager.instance.mostrarDebug) Debug.Log("SM: ERROR FALSEANDO habilidades -> " + e);
            }
        //}
        //else
        //{
    ...
    {
        if (GameManager.instance.mostrarDebug) Debug.Log("SM: llamando a " + uri);
        using (UnityWebRequest webRequest = UnityWebRequest.Get(uri))
        {
            ...
            if (webRequest.isNetworkError)
            {
                ...
                if (GameManager.instance.mostrarDebug) Debug.Log("SM Error: " + webRequest.error);
                GetRequest(uri);
            }
            else
            {
                if (GameManager.instance.mostrarDebug) Debug.Log("SM Éxito: " + webRequest.downloadHandler.text);
            }
        }
    }
